...
export interface PixelForgeApi {
  ...
  servers:{list:()=>Promise<ServerRecord[]>;create:(input:unknown)=>Promise<ServerRecord>;remove:(id:string)=>Promise<void>;start:(id:string)=>Promise<void>;stop:(id:string)=>Promise<void>;restart:(id:string)=>Promise<void>;command:(id:string,command:string)=>Promise<void>;logs:(id:string)=>Promise<ConsoleLine[]>}
